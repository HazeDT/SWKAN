...
def parse_args():
    ...
    # basic parameters
    parser.add_argument('--model_name', type=str, default='WKAN', help='the name of the model')
    parser.add_argument('--data_name', type=str, default='XJTU_Gearbox', help='the name of the data')
    parser.add_argument('--data_dir', type=str, default= "D:\Dataset\XJTU\XJTU_Gearbox", help='the directory of the data')
