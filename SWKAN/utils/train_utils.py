...
class train_utils(object):
    ...
    def setup(self):
        ...
        # Load the datasets
        dataset_module = getattr(datasets, args.data_name)
        Dataset = getattr(dataset_module, args.data_name)  # 关键在这一句

        print(Dataset)

        self.datasets = {}

        self.datasets['train'], self.datasets['val'] = Dataset(args.data_dir).data_prepare()
